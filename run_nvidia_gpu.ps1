...
# ==========================================================
& "$PSScriptRoot\comfy_env\Scripts\Activate.ps1"; python -s -W ignore::FutureWarning "$PSScriptRoot\ComfyUI\main.py" --normalvram --cache-lru 6 --windows-standalone-build --listen --temp-directory $env:COMFY_CACHE_DIR --enable-cors-header --port $env:COMFYUI_PORT
